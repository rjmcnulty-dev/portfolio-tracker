...
// Estimated, not billing-accurate — computed from token counts against
// configurable per-million-token rates (ai_companion_pricing in app_config),
// not pulled from Anthropic's actual account billing. Good enough to track
